...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, firstName: $firstName, lastName: $lastName, dateOfBirth: $dateOfBirth, gender: $gender, email: $email, password: $password, imagePath: $imagePath)';
  }
...
abstract class _User implements User {
  const factory _User(
      ...
      final String? email,
      final String? password,
      final List<int>? imagePath}) = _$UserImpl;
